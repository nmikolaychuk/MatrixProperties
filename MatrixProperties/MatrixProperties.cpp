...
// MatrixProperties.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMatrixPropertiesApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMatrixPropertiesApp

CMatrixPropertiesApp::CMatrixPropertiesApp()
{
...
// Единственный объект CMatrixPropertiesApp

CMatrixPropertiesApp theApp;


// Инициализация CMatrixPropertiesApp

BOOL CMatrixPropertiesApp::InitInstance()
{
